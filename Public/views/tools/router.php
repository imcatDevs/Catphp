        ...
        <div class="card__body p-0">
            <table class="table table--sm mb-0">
                ...
                <tbody>
                    ...
                    <tr><td><code>redirect(string $from, string $to, int $code)</code></td><td><code>self</code></td><td>리다이렉트 라우트. 기본 301</td></tr>
...
<span class="hl-f">router</span>()-&gt;<span class="hl-f">dispatch</span>();</code></pre>
    ...
    <div class="alert alert--danger mb-3">
        <span class="alert__message"><strong>404 공격 방어:</strong> 매칭 실패(404) 시 IP 기준 레이트 리미트(1분/30회)를 적용합니다. 초과 시 403을 반환하고, 10분/100회 초과 시 Firewall 자동 밴이 적용됩니다. <code>.env</code>, <code>wp-admin</code> 등 위험 경로는 1회 = 5회로 가중 카운팅됩니다.</span>
    </div>
